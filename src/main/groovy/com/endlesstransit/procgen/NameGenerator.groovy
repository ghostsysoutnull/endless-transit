 ...
 * Every method requires an explicit seed to ensure cross-session stability.
 */
@CompileStatic
class NameGenerator {

    static String generateSolarSystemName(long seed) {
    ...
    static String generatePlanetName(long seed) {
        Random r = new Random(seed)
    ...
    static String generateCountryName(long seed) {
        Random r = new Random(seed)
    ...
    static String generateCityName(long seed) {
        Random r = new Random(seed)
    ...
    static String generateStreetName(long seed) {
        Random r = new Random(seed)
    ...
    static String generateFilamentName(long seed) {
        Random r = new Random(seed)
    ...
    static String generateSectorName(long seed) {
        Random r = new Random(seed)
    ...
    static final Map<String, Map> roomLexicon = buildingLexicon
    ...
    static Map<String, String> generateRoomName(String culture, String trait, long seed) {
        Random r = new Random(seed)
    ...
    static Map<String, Object> generateBuildingName(String culture, int floors, long seed, int depth, boolean isNullZone, boolean isAbyssal) {
        Random r = new Random(seed)
    ...
    static String generateContainerName(long seed) {
        Random r = new Random(seed)
