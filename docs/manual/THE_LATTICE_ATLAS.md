...
| **02** | `⬚` | Galactic Sector | Dense clusters of matter and data adrift in the void. |
...
| **09** | `▤` | Floor | Functional zones (Research, Living, Executive). |
...
## [THE GREAT CULTURES]
Every planet in the web is defined by a dominant **Culture**—a set of procedural templates that shape the architecture, objects, and "vibe" of its structures.

*   **RUST (The Industrial Decay):** Gritty, oxidized, and functional. Focuses on sums, shafts, and mechanical relics.
...
---
*Proceed to the [OPERATIONAL_PROTOCOLS](OPERATIONAL_PROTOCOLS.md) to master the mechanics of the link.*
