...
| 5 | **Deviations from the plan document** | Each difference between the draft and the phase section, with the reason. Silent deviations are a FAIL. | PASS / UNDECLARED |
