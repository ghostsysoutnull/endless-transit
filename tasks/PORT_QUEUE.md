...
| [x] | I06 | **Items**: capture, inventory, quantum buffer, gematria, spectral frequency, synthesis | collect, inspect, combine and drop relics |
...
| [ ] | I09 | **Polish** (phone: a panel opened by SCAN/MAP/TRACE sits below the fold under the dock — scroll it into view; the first screen of a room/corridor shows no move without scrolling; the dock): help, debug mode, reduced motion, focus, phone layout fine-tuning, first-screen fold on phone (a move visible without scrolling — I04 review: a room or corridor's first screen shows none, a 20-door corridor is ≈ 6 screens at 360×640); every known bug of decision 7 confirmed fixed by a test | play a full run comfortably with one thumb |
