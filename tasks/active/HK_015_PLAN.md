...
**Status:** AUTHORIZED 2026-09-17 (Directive: "yes, execute the plan") — in progress. **User decisions (2026-09-17):** D1 = a, *saved* (once per step, one int in the save); D2 = a (alias `q`); D3 = a (seed the echo roll in the same commit); D4 = a (all five items).
