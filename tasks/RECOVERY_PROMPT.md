# RECOVERY HANDOVER
**Last updated:** 2026-09-26 (the Solo loop is the default process; UI rework: U01a and U01b live; U02 next; phones only). This file holds **current state only** — history lives in `journals/CHRONICLE_INDEX.md` and the logs it points to; `./.claude/docs-check.sh` caps this file at 1,000 words.
...
4. **"hi" runs `tasks/UI_QUEUE.md`** under the Solo loop (the Standing Order when the user asks); anything else waits for a Directive.
