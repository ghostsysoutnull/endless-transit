# RECOVERY HANDOVER
**Last updated:** 2026-09-25 (the rules diet is done; the UI rework is queued, nothing run yet). This file holds **current state only** — history lives in `journals/CHRONICLE_INDEX.md` and the logs it points to; `./.claude/docs-check.sh` caps this file at 1,000 words.
