...
- [ ] Next: user decision — **HK-015** (player-facing bugs; items 1–2 are gameplay changes), O1 (HeadlessRunner DSL), HK-013 (nine long methods), or a new audit. Other open items: **HK-015** (player-facing bugs; items 1–2 are gameplay changes), O1 (HeadlessRunner DSL), HK-013 (nine long methods)
