...
- [ ] Next: **HK-016 step 2** (structural: shuffled deck, furniture ≠ objects, timeline drift, phrasings, category names, description variants), then **step 3** (grow lists). Other open items: **HK-015** (player-facing bugs; items 1–2 are gameplay changes), O1 (HeadlessRunner DSL), HK-013 (nine long methods)
