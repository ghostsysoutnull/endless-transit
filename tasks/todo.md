...
- [ ] Next: **HK-016 step 3** (grow lists: culture/era items 8 → ~16, atmosphere 5 → ~10, conditions 8 → ~16, lexicons ~12×12, doors ~12/12; step 2 made every list the binding constraint). Other open items: **HK-015** (player-facing bugs; items 1–2 are gameplay changes), O1 (HeadlessRunner DSL), HK-013 (nine long methods)
